...
public class CadastroUsuarioTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        novoLoginTextField.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        novoLoginTextField.setToolTipText("");
        novoLoginTextField.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        label2.setText("Confirme a senha");

        label3.setText("Cadastro de Usuario");
    ...
    private void cadastrarUsuarioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarUsuarioButtonActionPerformed
        ...
        if (novaSenha.equals(confirmaNovaSenha)){
            try {
                ...
                // Cria um novo usuário com o login e senha informados
                Usuarios novoUsuario = new Usuarios(novoLogin, novaSenha);
            ...
            // Senhas não coincidem, exibe uma mensagem de erro
